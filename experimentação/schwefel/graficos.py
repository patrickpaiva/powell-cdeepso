...
def generate_graphics():
    for dim in dimensoes:
        ...
        ax.set_title(f'{title_function} {dim} dimensões')
        ax.set_ylabel('Best Fitness')

        output_file = os.path.join(base_path, f'boxplot_comparacao_{function}_{dim}_{data_hora_atual}.png')
