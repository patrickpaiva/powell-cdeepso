...
def c_deepso_powell_global_best_com_kmeans(function, dimension, swarmSize, lowerBound, upperBound,
    ...
    while True:
        ...
        #   print(f"V1 - Geração: {k} Dispersão: {intra_cluster_distance} fitness: {g_best_fitness}")
          if intra_cluster_distance < dispersion_threshold or (max_iter is not None and k == (max_iter - 5)):
